This is a blogApp made in the Django where the user can upload the blog perform CRUD operation in it and can also view the others blog based on the recent concurrent issues..
